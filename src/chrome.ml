module Identity = struct
  ...
  external mkAuthOptions : ?interactive:bool -> ?scopes:string list -> ?account:accountInfo -> unit -> getAuthTokenOptions = "" [@@bs.obj]
  ...
  external mkWebFlowOptions : url:string -> ?interactive:bool -> unit -> webAuthFlowOptions = "" [@@bs.obj]
  ...
  module OnSignInChanged = struct
    external addListener : (accountInfo -> bool -> 'a) -> unit = "addListener" [@@bs.scope "chrome", "identity", "onSignInChanged"] [@@bs.val]
  end
end
